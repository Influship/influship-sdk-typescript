...
[![NPM version](<https://img.shields.io/npm/v/influship-api.svg?label=npm%20(stable)>)](https://npmjs.org/package/influship-api) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/influship-api)
...
```sh
npm install git+ssh://git@github.com:stainless-sdks/influship-api-typescript.git
```

> [!NOTE]
> Once this package is [published to npm](https://www.stainless.com/docs/guides/publish), this will become: `npm install influship-api`
...
```ts
import InflushipAPI from 'npm:influship-api';
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/influship-api-typescript/issues) with questions, bugs, or suggestions.
