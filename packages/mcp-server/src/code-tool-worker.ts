...
import { Influship, ClientOptions } from 'influship';
...
function getTSDiagnostics(code: string): string[] {
  ...
  const codeWithImport = [
    ...
    functionSource.type === 'declaration' ?
      `async function run(${functionSource.client}: Influship)`
    : `const run: (${functionSource.client}: Influship) => Promise<unknown> =`,
    functionSource.code,
  ].join('\n');
...
const fuse = new Fuse(
  [
    'client.health.check',
    'client.creators.autocomplete',
    'client.creators.lookalike',
    ...
    'client.raw.instagram.getTranscripts',
    'client.raw.youtube.getChannel',
    'client.raw.youtube.getChannelTranscripts',
    'client.raw.youtube.getTranscript',
    'client.raw.youtube.getVideo',
    'client.raw.youtube.search',
    'client.raw.youtube.typeahead',
    'client.raw.tiktok.getMusic',
    'client.raw.tiktok.getProfile',
    'client.raw.tiktok.getVideo',
    'client.raw.tiktok.getVideoCaptions',
    'client.raw.tiktok.getVideoTranscript',
    'client.raw.tiktok.getVideoTranscripts',
    'client.raw.tiktok.getVideos',
    'client.raw.tiktok.listCommentReplies',
    'client.raw.tiktok.listHashtagVideos',
    'client.raw.tiktok.listMusicVideos',
    'client.raw.tiktok.listProfileVideos',
    'client.raw.tiktok.listVideoComments',
    'client.raw.tiktok.searchUsers',
    'client.raw.tiktok.searchVideos',
  ],
