...
const fuse = new Fuse(
  [
    ...
    'client.lookalike.findSimilarCreators',
    'client.posts.analyze',
    'client.posts.listByCreator',
    'client.match.analyze',
    'client.brandSafety.analyzeCreators',
    'client.brandSafety.analyzePosts',
    'client.brandSafety.analyzeProfiles',
  ],
